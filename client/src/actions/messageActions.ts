...
export const getMessages = () => async (dispatch: any, getState: any) => {
  dispatch({
...
export const addMessage = (formData: any) => async (dispatch: any, getState: any) => {
  dispatch({
...
export const deleteMessage = (id: any) => async (dispatch: any, getState: any) => {
  dispatch({
...
export const editMessage = (id: any, formData: any) => async (dispatch: any, getState: any) => {
  dispatch({
...
export const clearMessageError = (id: any) => ({
