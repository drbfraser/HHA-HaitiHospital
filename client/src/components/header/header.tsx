        ...
        <div className="col-auto">
          <div className="dropdown">
            ...
            <ul className="dropdown-menu dropdown-menu-end rounded shadow">
              ...
              <li>
                <button data-testid="user-role" className="dropdown-item disabled text-muted mb-2">
                  <i className="bi bi-person-badge-fill"></i>
                  {i18n.t(userInfo.role)}
                </button>
              </li>
              <li className={`${userInfo.department.name ? 'd-block' : 'd-none'}`}>
                <button data-testid="user-department" className="dropdown-item disabled text-muted">
