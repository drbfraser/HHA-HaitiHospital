...
interface BrokenKitViewProps extends ElementStyleProps {
}
      ...
      return(
        ...
        <SideBar/>
            ...
            <div className="ml-3 d-flex justify-content-start">
                <Link to="/biomechanic"><button type="button" className="btn btn-outline-dark">Back</button></Link>
            </div>
            <div className="mb-5 col-lg-6 col-md-8 col-sm-10 col-12"> 
                <div>
                    ...
                    <h6 className="fs-6 fw-bold lh-base">Fault with Equipment</h6>
