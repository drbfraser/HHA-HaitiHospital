    ...
    <div className={"case-study-main"}>
      ...
      <main className="container-fluid main-region">
        ...
        <div className="ml-3 d-flex justify-content-start">
          <Link to="/case-study"><button type="button" className="btn btn-outline-dark">{translateText("caseStudyFormBack")}</button></Link>
        </div>
        <div className="mb-5 col-lg-6 col-md-8 col-sm-10 col-12">
          {(caseStudy !== {} && caseStudy.caseStudyType === CaseStudyOptions.PatientStory) ? 
            <div>
              ...
              <h6 className="fs-6 fw-bold lh-base">{translateText("caseStudyFormWherePatientFrom")}</h6>
              <p className='fs-6 lh-base text-break'>{caseStudy.patientStory.whereIsThePatientFrom}</p>
              <h6 className="fs-6 fw-bold lh-base">{translateText("caseStudyFormWhyPatientChooseHCBH")}</h6>
              ...
              <h6 className="fs-6 fw-bold lh-base">{translateText("caseStudyFormWhatWasTheirDiagnosis")}</h6>
          ...
          {(caseStudy !== {} && caseStudy.caseStudyType === CaseStudyOptions.StaffRecognition) ? 
            <div>
              ...
              <h6 className="fs-6 fw-bold lh-base">{translateText("caseStudyFormWhichDepartmentWorkIn")}</h6>
              <p className='fs-6 lh-base text-break'>{caseStudy.staffRecognition.department}</p>
              <h6 className="fs-6 fw-bold lh-base">{translateText("caseStudyFormHowLongHaveBeenWorkingHCBH")}</h6>
              <p className='fs-6 lh-base text-break'>{caseStudy.staffRecognition.howLongWorkingAtHcbh}</p>
              <h6 className="fs-6 fw-bold lh-base">{translateText("caseStudyFormWhatEnjoyTheMostAtHCBH")}</h6>
          ...
          {(caseStudy !== {} && caseStudy.caseStudyType === CaseStudyOptions.TrainingSession) ? 
            <div>
              ...
              <h6 className="fs-6 fw-bold lh-base">{translateText("caseStudyFormWhoConductedTraining")}</h6>
              <p className='fs-6 lh-base text-break'>{caseStudy.trainingSession.whoConducted}</p>
              <h6 className="fs-6 fw-bold lh-base">{translateText("caseStudyFormWhoAttendedTraining")}</h6>
              <p className='fs-6 lh-base text-break'>{caseStudy.trainingSession.whoAttended}</p>
              <h6 className="fs-6 fw-bold lh-base">{translateText("caseStudyFormHowWillTrainingBenefitHCBH")}</h6>
          ...
          {(caseStudy !== {} && caseStudy.caseStudyType === CaseStudyOptions.EquipmentReceived) ? 
            <div>
              ...
              <h6 className="fs-6 fw-bold lh-base">{translateText("caseStudyFormWhoWasEquipmentFrom")}</h6>
              <p className='fs-6 lh-base text-break'>{caseStudy.equipmentReceived.whoSentEquipment}</p>
              <h6 className="fs-6 fw-bold lh-base">{translateText("caseStudyFormWasItDonatedOrPurchased")}</h6>
              <p className='fs-6 lh-base text-break'>{caseStudy.equipmentReceived.purchasedOrDonated}</p>
              <h6 className="fs-6 fw-bold lh-base">{translateText("caseStudyFormWhatDoesThisNewEquipmentDo")}</h6>
