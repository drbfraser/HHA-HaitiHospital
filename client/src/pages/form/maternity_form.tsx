                                                    ...
                                                    <table>
                                                        <tbody>
                                                            ...
                                                            {/* {(() => {
                                                                ...
                                                                for(let i = 0; i < field.total_rows; i++){
                                                                    for(let j = 0; j < field.row_labels.length; j++){
                                                                        var labels = field.row_labels[j];
                                                                        var spans = field.row_spans[j];

                                                                        if(count[j] === 0){
                                                                            return (
                                                                                <tr>
                                                                                    <th rowSpan={spans[k[j]]}>{labels[k[j]]}</th>
                                                                                </tr>
                                                                            );
                                                                        }
                                                                        ...
                                                                        if(count[j] === spans[k[j]]){
                                                                            k[j]++;
                                                                            count[j] = 0;
                                                                        }
                                                                    }

                                                                    for(let j = 0; j < field.total_cols; j++){
                                                            ...
                                                            {/* {field.row_labels.map((row, coli) => (
                                                                coli < field.row_labels.length - 2 ?
                                                                    row.map((x, y) => (
                                                                        <tr>
                                                                            <th rowSpan={field.row_spans[coli][y]}>{x}</th>
                                                                        </tr>
                                                                    ...
                                                                    coli === field.row_labels.length - 2 ?
                                                                        ...
                                                                        [...Array(field.row_labels[coli].length)].map((e, i) => (
                                                                            
                                                                            <>
                                                                                <tr>
                                                                                    <th rowSpan={field.row_spans[coli][i]}>{row[i]}</th>
                                                                                </tr>

                                                                                {[...Array(field.row_labels[coli+1].length)].map((e, index) => (
                                                                                    <tr>
                                                                                        <th>{field.row_labels[coli + 1][index + i*(field.row_spans[coli][i]-1)]}</th>
                                                                                        {[...Array(field.total_cols)].map((i) => (
