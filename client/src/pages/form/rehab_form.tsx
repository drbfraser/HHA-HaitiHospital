                ...
                <div className="form-group">
                    <div className="row g-2 pb-2">
                        <div className="col-sm-10 ps-5">
                            ...
                            <select className="form-select-sm ps-1 mb-3" aria-label=".form-select-sm" onChange={(e) => selectList(e.target.value, state, field)}>
                                ...
                                {field.field_template.map((item: any) => (
                                    item.field_type === "select" ?
                                        <>
                                            ...
                                            <div id={"ListInputs" + i} className="col-sm-4">
                                                <select className="form-select" {...register(item.field_parent + ".patients.patient" + (i + 1) + "." + item.field_id)}>
