...
import { BiomechanicalPage } from 'pages/biomech/main/biomechanical';
import { BrokenKitReport } from 'pages/biomech/form/broken_kit_report';
import { BrokenKitView } from 'pages/biomech/view/broken_kit_report_view';
