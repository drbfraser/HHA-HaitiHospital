...
export class TextQuestionTest extends QuestionLeafTest<number, string, string> {
  constructor() {
    super({
      questionLeafConstructor: (id: number, prompt: string, defaultAnswer?: string) => new TextQuestion(id, prompt, defaultAnswer),
...
export class NumericQuestionTest extends QuestionLeafTest<number, number, string> {
  constructor() {
    super({
      questionLeafConstructor: (id: number, prompt: string, defaultAnswer?: number) => new NumericQuestion(id, prompt, defaultAnswer),
