...
const buildNicuPaedsMockReport = () => {
  ...
  const q4: CompositionQuestion<string, string> = new CompositionQuestion<string, string>("Hospitalization Local", '4');
  ...
  const q5: CompositionQuestion<string, string> = new CompositionQuestion<string, string>("Discharged From", '5');
  ...
  const q6: CompositionQuestion<string, string> = new CompositionQuestion<string, string>("Local of Death", '6');
  ...
  const q7: CompositionQuestion<string, string> = new CompositionQuestion<string, string>("Local of Death", '7');
