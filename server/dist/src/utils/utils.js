...
var deleteAllAvatars = function (absoluteFolderPath) { return __awaiter(void 0, void 0, void 0, function () {
    var files, unlinkPromises, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, readdir(absoluteFolderPath)];
            case 1:
                files = _a.sent();
                ...
                return [2 /*return*/, Promise.all(unlinkPromises)];
            case 2:
                err_1 = _a.sent();
                console.log(err_1);
                return [3 /*break*/, 3];
