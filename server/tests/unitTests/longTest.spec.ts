...
describe('Test parsing json string to a jsonReportDescriptor', () => {
  ...
  it('should parse sucessfully', (done) => {
    try {
      const stringJson =
        '{"meta":{"id":"1234","departmentId":"1234","submittedDate":"1234","submittedUserId":"123"},"items":[{"meta":{"type":"something"},"description":"item 1","answer":[["answer 1 - item 1","answer 2 - item 1"]]},{"meta":{"type":"table"},"description":"a table","answer":[["answer 1 - col 1","answer 2 - col 1"],["answer 1 - col 2"]]}]}';
      ...
      chai.expect(JSON.stringify(actual) == JSON.stringify(expected), true);
